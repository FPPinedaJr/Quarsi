    ...
    <body class="flex justify-center w-screen min-h-screen mt-20 overflow-x-hidden">
                ...
                <div id="officer-<?php echo $officer['iduser'] ?>"
                    ...
                    <div id=""
                        ...
                        <div class="flex h-full min-w-16 w-16 mr-2 justify-center items-center px-1 md:absolute md:-left-[2.5rem] md:min-w-0 md:w-fit md:p-1 md:bg-emerald-700/20 md:rounded-l-lg cursor-default">
                            <img class="w-full border border-gray-300 rounded-full md:w-8" src="data:image/jpeg;base64, <?= base64_encode($officer['profile_pic']) ?>">
                        </div>
        ...
        <div id="add_officer_modal"
            ...
            <div id="add_officer_modal_main" class="relative flex flex-col w-5/6 h-fit md:w-3/5">
                ...
                <div class="w-full h-fit flex bg-[#fbfcf8] p-1">
                    <form id="add_officer_form" action="./includes/crud_officer.php" enctype="multipart/form-data"
        ...
        <div id="edit_officer_modal"
            ...
            <div id="edit_officer_modal_main" class="relative flex flex-col w-5/6 overflow-y-auto h-4/5 md:h-fit md:w-3/5">
                ...
                <!-- fieldset -->
                <div class="w-full h-fit flex bg-[#fbfcf8] p-1">
                    <form id="edit_officer_form" action="./includes/crud_officer.php" enctype="multipart/form-data"
                        type="button" method="POST" class="flex flex-col justify-center w-full h-full px-3">
