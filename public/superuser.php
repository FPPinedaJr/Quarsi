...
if (!$_SESSION["logged_in"] || !($_SESSION['is_admin'] == 1)) {
    ...
    <body class="flex justify-center w-screen min-h-screen mt-20 overflow-x-hidden">
        <main class="flex flex-col justify-center w-full px-3 py-2 h-fit">
            ...
            <?php foreach ($superusers as $superuser): ?>
                <div id="superuser-<?php echo $superuser['iduser'] ?>"
                    ...
                    data-profile_pic="<?= base64_encode($superuser['profile_pic']) ?>"
        ...
        <div id="add_superuser_modal"
            ...
            <div id="add_superuser_modal_main" class="relative flex flex-col w-5/6 h-fit md:w-3/5">
                ...
                <div class="w-full h-fit flex bg-[#fbfcf8] p-1">
                    <form id="add_superuser_form" action="./includes/crud_superuser.php" enctype="multipart/form-data"
        ...
        <div id="edit_superuser_modal"
            ...
            <div id="edit_superuser_modal_main"
                ...
                <!-- fieldset -->
                <div class="w-full h-fit flex bg-[#fbfcf8] p-1">
                    <form id="edit_superuser_form" action="./includes/crud_superuser.php" enctype="multipart/form-data"
                        type="button" method="POST" class="flex flex-col justify-center w-full h-full px-3">
    ...
    <script>
        ...
        function showEditSuperuserModal(id) {
            ...
            var $hidden_profile = $('#superuser-' + id).data('profile_pic');
